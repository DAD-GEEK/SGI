...
namespace Web.Models
{
    public class IndexViewModel
    {
        ...
        public Terceros TerceroUsuarioModel { get; set; }
        public AspNetUsers UsuarioModel { get; set; }
    }
    ...
    public class ChangePasswordViewModel
    {
        ...
        [Required]
        [StringLength(100, ErrorMessage = "La {0} debe contener al menos {2} caracteres.", MinimumLength = 3)]
        [DataType(DataType.Password)]
        [Display(Name = "Nueva contraseña")]
        public string NewPassword { get; set; }
