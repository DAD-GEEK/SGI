...
window.Parsley.on('field:error', function () {
    ...
    $('.nav-pills a[href="' + '#' + (this.$element.closest('.tab-pane').attr('id')) + '"]').addClass('validation_errors bg-danger');
...
window.Parsley.on('field:success', function () {
    ...
    if (this.$element.closest('.validation_error').children().find('.parsley-error').length) {
        ...
        $('.nav-pills a[href="' + '#' + (this.$element.closest('.tab-pane').attr('id')) + '"]').removeClass('validation_errors bg-danger');
    }
});
